        ...
        while (continueLoop) {
            ...
            switch (selection) {
                ...
                case "Add a role":
                    ...
                    await dbManager.addRole(roleAnswers.title, roleAnswers.salary, roleAnswers.department_id);
                ...
                case "Add an employee":
                    ...
                    await dbManager.addEmployee(employeeAnswers.first_name, employeeAnswers.last_name, employeeAnswers.role_id, employeeAnswers.manager_id === 'NULL' ? null : employeeAnswers.manager_id);
